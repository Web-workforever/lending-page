...
search_icon.addEventListener('click', function(e) {
	let search__input = document.querySelector('.search-header__input');
	search__input.classList.toggle('active');
});
let icon = document.querySelector('.icon-menu');
let menu = document.querySelector('.menu__list');
let menu__body = document.querySelector('.menu');
...
if (sliders) {
	for (let index = 0; index < sliders.length; index++) {
		...
		if (!slider.classList.contains('swiper-bild')) {
			...
			slider.classList.add('swiperbild');
		}
...
let mainslider__body = new Swiper('.swiper-container', {
	/* 
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// navigation: {
	// 	nextEl: '.about_more .more__item_next',
